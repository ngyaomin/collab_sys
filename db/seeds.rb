...
posts = Post.create([
                      { title: 'Poem', topic: 'Chinese', content: '无论是解脱也好成就佛道也好最重要的莫过于深信因果。因为就算是空性，空性的本性也脱离不了因果。所以一切法的根本就是因果。脱离因果的一切法就是因果。', user_id: 3 },
...
Thus what ever arise, let it arise, what ever cease, let it cease, like ocean waves this is the nature, the nature of the waves, but keep in mind that the sea bed is forever stable, that is the real nature. watch the waves but keep in mind the real nature and you shall never be seperated from boddicttia.', user_id: 3 },
                      { title: 'Master', topic: 'English', content: 'The master continue "look nowhere my dear student, look nowhere. Seek no path my dear student, seek no path. The day you see me as a Buddha is the day you know the truth. Every Path that does not link to the Buddha nature is nothing but temperol. The only Buddha dharma is the mind, the mind is the pure essense of the Buddha dharma , the Buddha dharma is nothing but the nature of the mind. "', user_id: 3 },
...
"I dont know any Dharma, I never learn any Dharma, and even if I did I have already forgotten them"', user_id: 3 }
